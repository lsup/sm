    ...
    ui: {
        ...
        tabs: {
            ...
            createTab: function (options) {
                var mergedOptions = $.extend(this.defaultOptions, options);
...
$.layouts = {
    ...
    initLayout: function () {
        ...
        this.layout = $('.index-panel').layout({
            west__size: 210, south__size: 30, west__spacing_closed: 20, west__togglerLength_closed: 100, west__togglerContent_closed: "菜<BR>单", togglerTip_closed: "打开", togglerTip_open: "关闭", sliderTip: "滑动打开", resizerTip: "调整大小", onhide: resizePanel, onshow: resizePanel, onopen: resizePanel, onclose: resizePanel, onresize: resizePanel, center__maskContents: true // IMPORTANT - enable iframe masking
            , north: {
                togglerLength_open: 0, resizable: false, size: 95
            },
            south: {
                resizable: false
            }
